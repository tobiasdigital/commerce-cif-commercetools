...
const samplePaymentMethodsList = JSON.parse(JSON.stringify(samplePaymentMethods));
        ...
        it('returns the correct list of methods', () => {
            ...
            return action(args)
                .then(result => {
                    ...
                    assert.lengthOf(result.response.body, samplePaymentMethodsList.body.length);
                });
        });
