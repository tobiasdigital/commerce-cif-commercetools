...
Please follow the [issue template](ISSUE_TEMPLATE/BUG_REPORT.md) to open new [issues](https://github.com/adobe/commerce-cif-commercetools/issues) and join the conversations to provide feedback. 
